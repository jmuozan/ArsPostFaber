...
namespace crft
{
  public class crftComponent : GH_Component
  {
    /// <summary>
    ...
    /// </summary>
    public crftComponent()
      : base("crft Component", "Nickname",
    ...
    /// </summary>
    public override Guid ComponentGuid => new Guid("0f1f5e04-0f97-44c3-ab45-d530da791887");
  }
}